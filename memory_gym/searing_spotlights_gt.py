...
class SearingSpotlightsGTEnv(CustomEnv):
    ...
    def process_reset_params(reset_params):
        ...
        """
        cloned_params = SearingSpotlightsGTEnv.default_reset_parameters.copy()
    ...
    def reset(self, seed = None, return_info = True, options = None):
        ...
        self.reset_params = SearingSpotlightsGTEnv.process_reset_params(options)
        ...
        return {"visual_observation": vis_obs, "vector_observation": np.asarray(self.agent.rect.center) / self.screen_dim}, {}
    ...
    def step(self, action):
        ...
        return {"visual_observation": vis_obs, "vector_observation": np.asarray(self.agent.rect.center) / self.screen_dim}, reward, done, False, info
    ...
    def render(self):
        if self.render_mode is not None:
            if self.render_mode == "rgb_array":
                self.clock.tick(SearingSpotlightsGTEnv.metadata["render_fps"])
...
def main():
    ...
    env = SearingSpotlightsGTEnv(render_mode = "debug_rgb_array")
    reset_params = {}
    seed = options.seed
