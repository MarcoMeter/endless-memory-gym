...
class SearingSpotlightsSanityEnv(gym.Env):
    ...
    def step(self, action):
        ...
        return {"visual_observation": vis_obs, "vector_observation": np.asarray([self.agent.rect.center[0] / self.screen_dim, self.agent.rect.center[1] / self.screen_dim])}, reward, done, info
...
def main():
    ...
    env = SearingSpotlightsSanityEnv(headless = False)
    reset_params = {}
    seed = options.seed
